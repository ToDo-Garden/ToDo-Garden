...
public protocol GuideScenePayloadable {
	// var name: String { get }
}

public protocol GuideSceneBuildable {
	...
	func build(with payload: GuideScenePayloadable) -> GuideViewControllable
}
