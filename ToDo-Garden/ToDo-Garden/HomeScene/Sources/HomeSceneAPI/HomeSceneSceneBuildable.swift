...
public protocol HomeSceneScenePayloadable {
  // var name: String { get }
}

@MainActor
public protocol HomeSceneSceneBuildable {
  ...
  func build(with payload: HomeSceneScenePayloadable) -> HomeSceneViewControllable
}
