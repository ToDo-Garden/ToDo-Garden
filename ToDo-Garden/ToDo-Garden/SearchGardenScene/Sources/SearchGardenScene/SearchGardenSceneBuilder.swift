...
extension SearchGardenSceneBuilder: SearchGardenSceneBuildable {
  ...
  public func build(with payload: SearchGardenScenePayloadable) -> SearchGardenViewControllable {
    let searchGardenScene = self.configureVIPCycle(
      for: SearchGardenViewController(),
      with: payload
    )
    return searchGardenScene
  }
}
...
extension SearchGardenSceneBuilder {
  ...
  private func configureVIPCycle(
    for viewController: SearchGardenViewController,
    with payload: SearchGardenScenePayloadable
  ) -> SearchGardenViewController {
    ...
    router.searchGardenSceneDelegate = payload.searchGardenSceneDelegate
