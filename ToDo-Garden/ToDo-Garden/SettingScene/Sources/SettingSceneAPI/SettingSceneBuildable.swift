...
public protocol SettingScenePayloadable {
	// var name: String { get }
}

public protocol SettingSceneBuildable {
	...
	func build(with payload: SettingScenePayloadable) -> SettingViewControllable
}
