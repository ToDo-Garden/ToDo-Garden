...
public protocol InputIDScenePayloadable {
  // var name: String { get }
}

public protocol InputIDSceneBuildable {
  ...
  func build(with payload: InputIDScenePayloadable) -> InputIDViewControllable
}
